...
namespace ProjektKarolewski.Migrations
{
    ...
    [Migration("20220303101239_03.03_poprawkabazy")]
    partial class _0303_poprawkabazy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjektKarolewski.Entities.Reply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ReplyProtocol")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ProjektKarolewski.Entities.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjektKarolewski.Entities.TicketStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjektKarolewski.Entities.Reply", b =>
                {
                    b.HasOne("ProjektKarolewski.Entities.TicketStatus", null)
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("ProjektKarolewski.Entities.Ticket", b =>
                {
                    ...
                    b.HasOne("ProjektKarolewski.Entities.Reply", "Reply")
                        .WithOne("Ticket")
                        .HasForeignKey("ProjektKarolewski.Entities.Ticket", "ReplyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjektKarolewski.Entities.TicketStatus", "TicketStatus")
                        .WithMany()
                        .HasForeignKey("TicketStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
